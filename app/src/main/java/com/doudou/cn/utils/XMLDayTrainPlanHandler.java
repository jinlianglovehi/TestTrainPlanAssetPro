...
//    private int rateEnd ; // 心率的终结位置
    ...
    private static final String NODE_SWIM_TIME_MIN  ="trainTimeMin";

    private static final String NODE_SWIM_TIME_MAX = "trainTimeMax";
    ...
    public void characters(char[] ch, int start, int length) throws SAXException {
        if(tagName!=null){
            ...
            }else if (tagName.equalsIgnoreCase(NODE_SWIM_TIME_MIN)){
                this.currentDayTrainPlan.setTrainTimeMin(Integer.parseInt(data));
            }else if(tagName.equalsIgnoreCase(NODE_SWIM_TIME_MAX)){
                this.currentDayTrainPlan.setTrainTimeMax(Integer.parseInt(data));
            }
        }
    }
    /*
